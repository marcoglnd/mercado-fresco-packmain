...
func (_m *Repository) Update(id int, sectionNumber int, currentTemperature int, minimumTemperature int, currentCapacity int, minimumCapacity int, maximumCapacity int, warehouseId int, productTypeId int) (sections.Section, error) {
