...
func (_m *Service) Create(ctx context.Context, section *domain.Section) (*domain.Section, error) {
...
func (_m *Service) GetAll(ctx context.Context) (*[]domain.Section, error) {
	ret := _m.Called(ctx)
...
func (_m *Service) GetById(ctx context.Context, id int64) (*domain.Section, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Service) Update(ctx context.Context, section *domain.Section) (*domain.Section, error) {
	ret := _m.Called(ctx, section)
