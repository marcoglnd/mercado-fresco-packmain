...
func (_m *Service) Create(cardNumberId string, firstName string, lastName string) (buyers.Buyer, error) {
...
func (_m *Service) Update(id int, cardNumberId string, firstName string, lastName string) (buyers.Buyer, error) {
