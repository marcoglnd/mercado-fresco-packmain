...
func createRandomProduct() (product Product) {
	product = Product{
		...
		Height:                         float64(utils.RandomCode()),
		Length:                         float64(utils.RandomCode()),
		NetWeight:                      float64(utils.RandomCode()),
		ProductCode:                    utils.RandomCategory(),
		RecommendedFreezingTemperature: float64(utils.RandomCode()),
		Width:                          float64(utils.RandomCode()),
