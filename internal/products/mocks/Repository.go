...
func (_m *Repository) CreateNewProduct(description string, expirationRate int, freezingRate int, height float64, length float64, netWeight float64, productCode string, recommendedFreezingTemperature float64, width float64, productTypeId int, sellerId int) (products.Product, error) {
