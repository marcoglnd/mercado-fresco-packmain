...
func (_m *EmployeeService) ReportAllInboundOrders(ctx context.Context) (*[]domain.InboundOrderE, error) {
	ret := _m.Called(ctx)
...
func (_m *EmployeeService) ReportInboundOrders(ctx context.Context, employeeId int64) (*domain.InboundOrderE, error) {
