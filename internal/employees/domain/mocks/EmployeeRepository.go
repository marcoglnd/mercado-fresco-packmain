...
func (_m *EmployeeRepository) ReportAllInboundOrders(ctx context.Context) (*[]domain.InboundOrderE, error) {
	ret := _m.Called(ctx)

	var r0 *[]domain.InboundOrderE
	if rf, ok := ret.Get(0).(func(context.Context) *[]domain.InboundOrderE); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*[]domain.InboundOrderE)
		}
	}
...
func (_m *EmployeeRepository) ReportInboundOrders(ctx context.Context, employeeId int64) (*domain.InboundOrderE, error) {
	ret := _m.Called(ctx, employeeId)

	var r0 *domain.InboundOrderE
	if rf, ok := ret.Get(0).(func(context.Context, int64) *domain.InboundOrderE); ok {
